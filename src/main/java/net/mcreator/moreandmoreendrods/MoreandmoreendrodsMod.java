...
import net.mcreator.moreandmoreendrods.init.*;
...
public class MoreandmoreendrodsMod {
	...
	public MoreandmoreendrodsMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		MoreandmoreendrodsModBlocks.REGISTRY.register(modEventBus);
		MoreandmoreendrodsModBlockEntities.REGISTRY.register(modEventBus);
		MoreandmoreendrodsModItems.REGISTRY.register(modEventBus);
		MoreandmoreendrodsModTabs.REGISTRY.register(modEventBus);
		MoreandmoreendrodsModMenus.REGISTRY.register(modEventBus);
		MoreandmoreendrodsModVillagerProfessions.PROFESSIONS.register(modEventBus);
