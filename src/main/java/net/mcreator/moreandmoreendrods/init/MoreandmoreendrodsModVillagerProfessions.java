...
public class MoreandmoreendrodsModVillagerProfessions {
	...
	public static final DeferredRegister<VillagerProfession> PROFESSIONS = DeferredRegister.create(ForgeRegistries.VILLAGER_PROFESSIONS, MoreandmoreendrodsMod.MODID);
	public static final RegistryObject<VillagerProfession> END_ROD_SELLER = registerProfession("end_rod_seller", () -> MoreandmoreendrodsModBlocks.EMERALD_END_ROD.get(),
	...
	private static RegistryObject<VillagerProfession> registerProfession(String name, Supplier<Block> block, Supplier<SoundEvent> soundEvent) {
		...
		return PROFESSIONS.register(name, () -> {
			...
			return new VillagerProfession(MoreandmoreendrodsMod.MODID + ":" + name, poiPredicate, poiPredicate, ImmutableSet.of(), ImmutableSet.of(), soundEvent.get());
		});
	}
