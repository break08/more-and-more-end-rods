...
public class MoreandmoreendrodsModBlocks {
	...
	public static final RegistryObject<Block> STONE_BRICK_END_ROD;
	public static final RegistryObject<Block> LONG_END_ROD;
	public static final RegistryObject<Block> CACTUS_END_ROD;
	public static final RegistryObject<Block> GLASS_END_ROD;
	static {
		...
		STONE_BRICK_END_ROD = REGISTRY.register("stone_brick_end_rod", StoneBrickEndRodBlock::new);
		LONG_END_ROD = REGISTRY.register("long_end_rod", LongEndRodBlock::new);
		CACTUS_END_ROD = REGISTRY.register("cactus_end_rod", CactusEndRodBlock::new);
		GLASS_END_ROD = REGISTRY.register("glass_end_rod", GlassEndRodBlock::new);
	}
